...
__global__ void GPU_minmax(unsigned int nim, unsigned int numRows, unsigned char* results, unsigned char* moves, unsigned char numPlys, unsigned char* ply) {
    ...
    results[numPlys] = 16;
    *ply = minResultArray(results) & 127;
}
